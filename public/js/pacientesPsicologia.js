$(document).ready(function () {
    // Inicializar DataTable para la tabla de pacientes de psicología
    const table = $('#pacientesPsicologiaTable').DataTable({
        language: {
    ...
    const logo = $('<img src="/images/icono_psicologia.png" alt="Logo Psicología" class="dt-logo">');
    ...
    // Hacer que las filas sean clicables para ver documentos del paciente
    ...
    $(document).on('click', '.btn-eliminar', function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch(`/pacientes/eliminar/${idExpediente}`, {
                    method: "POST",
                    headers: {
