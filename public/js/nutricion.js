...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (btnGuardar) {
      btnGuardar.addEventListener('click', async (e) => {
        ...
        // Recolectar SOLO datos de nutricional1
        const datosNutricional1 = {
          IDExpediente: window.idExpediente, // ¡O pásalo como variable global!
        ...
        console.log('Datos a enviar nutricional1:', datosNutricional1);
  
        try {
          const respuesta = await fetch(`/nutricion/historiaClinica/guardarNutricional1`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify(datosNutricional1),
          });
